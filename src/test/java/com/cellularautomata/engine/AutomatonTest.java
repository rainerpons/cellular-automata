...
/**
 * The <code>AutomatonTest</code> class is responsible for testing the <code>
 * testInitializeVectorMap()</code> method of the <code>Automaton</code> class.
 *
 * @author Rainer Pons
 */
public class AutomatonTest {
  ...
  /**
   * Sets up the associative array we wish to test as if it were generated by local update rule
   * AutomataEngine.DEFAULT_RULE and a sparse initial seed of length nine.
   */
  @Before
  public void setUp() {
  ...
  public void testInitializeVectorMap() {
    ...
    Map<Integer, Vector> actualMap =
        Automaton.initializeVectorMap(AutomataEngine.DEFAULT_RULE, new Vector("000010000"));
  ...
  public void testInitializeVectorMapNullSeed() {
    Automaton.initializeVectorMap(AutomataEngine.DEFAULT_RULE, null);
  }
}
